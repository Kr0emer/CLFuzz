...
std::string ECC_ValidatePubkey::ToString(void) const {
    ...
    ss << "expected Result: " << std::to_string(id) << std::endl;
    // if( id == 0){
    //     ss << "unset";
    // }else if(id == 1){
    //     ss << "true";
...
std::string BLS_Compress_G1::ToString(void) const {
    ...
    ss << "expected: " << std::to_string(expected) << std::endl;
    ss << "expected compressed: " << compressed.ToString() << std::endl;
...
std::string BLS_Compress_G2::ToString(void) const {
    ...
    ss << "expected: " << std::to_string(expected) << std::endl;
    ss << "expected compressed x: " << compressed.first.ToString() << std::endl;
    ss << "expected compressed y: " << compressed.second.ToString() << std::endl;
