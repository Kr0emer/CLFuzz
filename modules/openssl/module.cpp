...
const EVP_CIPHER* OpenSSL::toCMAC_EVPCIPHER(const component::SymmetricCipherType cipherType) const {
    using fuzzing::datasource::ID;
...
std::optional<component::MAC> OpenSSL::OpCMAC(operation::CMAC& op) {
    ...
    /* Initialize */
    {
        ...
        CF_CHECK_NE(cipher = toCMAC_EVPCIPHER(op.cipher.cipherType), nullptr);
